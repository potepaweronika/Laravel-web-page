        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="table-container text-sm text-zinc-100 dark:text-gray-500">
                ...
                <table class="text-sm text-zinc-50 dark:text-gray-500" data-toggle="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('storage/'.$img->image) }}" height="50%" width="50%"></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
                ...
                <div class=" table-container text-sm text-zinc-50 dark:text-gray-500">
                    <form action="{{ route('image.store') }}" method="POST" class="text-sm text-zinc-50 dark:text-gray-500" enctype="multipart/form-data">
                        @csrf
                        <label class="text-sm text-zinc-50 dark:text-gray-500">
